    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                <h1>Diligencias</h1><br>

                <form action="../insertDB/i_diligencias.php" method="POST" class="login-form">
                    <div class="form-group">
                      <label for="exampleFormControlSelect1">Id Unidad de Trabajo</label>
                      <select class="form-control" id="id_UnidadTrabajo" name="id_UnidadTrabajo">
                           <?php
                    ...
                    <div class="form-group">
                      <label for="exampleTextarea">Descripción de Diligencia</label>
                      <textarea class="form-control" maxlength="200" id="descripcion_diligencia" name="descripcion_diligencia" rows="3" required></textarea>
                    </div>

                    <div class="form-group">
                        <label for="exampleSelect1">Obligatorio</label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="orden" name="orden" placeholder="Ingrese Número de Orden" required>
                    </div> 
