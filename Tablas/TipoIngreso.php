    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                <h1>Tipo de Ingreso</h1><br>

               <form action="../insertDB/i_tipoingreso.php" method="POST" class="login-form">
                    <div class="form-group">
                      <label for="formGroupExampleInput">Descripción de Ingreso</label>
                      <input type="text" maxlength="100" class="form-control" id="descripcion_ingreso" name="descripcion_ingreso" required>
                    </div>
