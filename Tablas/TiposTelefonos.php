...
<head>
    ...
    <title>Form-TiposTelefonos</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                <h1>Tipos Telefonos</h1><br>

               
               <form action="../insertDB/i_tipotelefono.php" method="POST" class="login-form">
                    <div class="form-group">
                        <label for="formGroupExampleInput">Descripción Tipo Telénono</label>
                        <input type="text" class="form-control" maxlength="20" id="descricpcion_tipotelefono" name="descricpcion_tipotelefono" placeholder="Ingrese la Descripción de Acción" required>
                    </div>
