    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                <h1>Relación Familiar</h1><br>

                    <form action="../insertDB/i.relacionfamiliar.php" method="POST" class="login-form">
                    <div class="form-group">
                      <label for="formGroupExampleInput">Descripción de Relación Familiar</label>
                      <input type="text" class="form-control" maxlength="50" id="relacion_familiar" name="relacion_familiar" placeholder="Ingresa la Relación Familiar" required>
                    </div>
