...
<head>
    ...
    <title>Form-UnidadTrabajo</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                <h1>Unidad de Trabajo</h1><br>

                <form name="formroles" action="../insertDB/i_UnidadTrabajo.php" method="POST">
                    <div class="form-group">
                        <label for="formGroupExampleInput">Descripción Unidad</label>
                        <input type="text" class="form-control" maxlength="200" id="descripcion_unidad" name="descripcion_unidad" placeholder="Ingrese la Descripción" required>
                    </div>
